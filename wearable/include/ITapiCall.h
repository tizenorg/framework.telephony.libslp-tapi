 ...
 *
 * @par Important Notes:
 * - MO call setup continues in background. There are multiple states involved in the call setup procedure. Upon request completion
 ...
 *
 * @param[in] pParams
 * - #TelCallDial_t contains the CallType(TapiHandle *handle, whether it is a voice call or data call etc) and number.
 *
 *
 * @param [in] callback
 ...
 * Embedded call application
 *
 * @see tel_dial_call tel_end_call
 *
 ...
 * TelCallAnswerType_t AnsType;
 * tapi_response_cb callback;
 * void *user_data;
 *
 * ret_status = tel_answer_call (handle, pCallHandle, AnsType, callback, user_data); // call answer
 * @endcode
 *
 * @remarks
 * - None
 ...
 *
 * @param [in] EndType
 * - End Type - end specific call/end all calls/end all held calls/end all active calls
 *
 * @param [in] user_data
 *   - user data for user specification
 *
 ...
 * Embedded call application
 *
 * @see tel_dial_call tel_answer_call
 *
 * @code
 * #include <ITapiCall.h>
 *
 ...
 * TapiHandle *handle;
 * unsigned int CallHandle;
 * TelCallEndType_t EndType;
 * tapi_response_cb callback;
 * void *user_data;
 *
 * ret_status = tel_end_call (handle, pCallHandle, EndType, callback, user_data); // call end
 * @endcode
 *
 *
 * @remarks
 ...
 * void *user_data;
 *
 * ret_status = tel_hold_call(handle, CallHandle, callback, user_data); // hold call
 * @endcode
 *
 *
 ...
 * void *user_data;
 *
 * ret_status = tel_active_call(handle, CallHandle, callback, user_data); // active call
 * @endcode
 *
 * @remarks
 * - None
 ...
 * void *user_data;
 *
 * ret_status = tel_swap_call(handle, CallHandle1, CallHandle2, callback, user_data); // swap call
 * @endcode
 *
 * @see None.
 *
 ...
 * int pRequestID=0;
 *
 * ret_status= tel_join_call(handle, CallHandle1, CallHandle2, callback, user_data); // call join
 * @endcode
 *
 * @remarks
 * - None
 ...
 * void *user_data;
 *
 * ret_status= tel_split_call(handle, CallHandle, callback, user_data); // call split
 * @endcode
 *
 * @remarks
 * - None
 ...
 * tapi_response_cb callback;
 * void *user_data;
 * ret_status= tel_get_call_act_line(handle, callback, user_data); // get call active line
 * @endcode
 *
 * @remarks
 * - None
 ...
 * void *user_data;
 *
 * ret_status = tel_set_call_act_line (handle, active_line, callback, user_data); // set call active line
 * @endcode
 *
 * @remarks
 * - None
 ...
 * void *user_data;
 *
 * ret_status= tel_transfer_call (handle, pCallHandle, callback, user_data); // explicit transfer
 * @endcode
 *
 * @remarks
 * -None
 ...
 * int call_id;
 * TapiHandle *handle;
 * TelCallStatus_t *out; // allocate memory
 *
 * ret_status= tel_get_call_status(handle, call_id, out); // get call status info
 * @endcode
 *
 *
 * @see None.
 ...
 * TapiHandle *handle
 * unsigned int CallHandle;
 * unsigned int * pDurationInSecs; // allocate memory
 *
 * ret_status= tel_get_call_duration(handle, CallHandle, pDurationInSecs); // get call duration
 * @endcode
 *
 *
 * @see None.
 ...
 * TapiHandle *handle;
 * unsigned int CallHandle;
 * const TelCallDeflectDstInfo_t *deflect_info; //allocate memory
 * tapi_response_cb callback;
 * void *user_data;
 *
 * tel_deflect_call(handle, CallHandle, deflect_info, callback, user_data); // call deflect
 *
 * @endcode
 *
 * @see None.
 ...
 * int req_id;
 *
 * ret = tel_activate_call_ccbs(handle, call_handle, callback, user_data); // ccbs activate
 * @endcode
 *
 *
 * @see None.
 ...
 * TapiHandle *handle;
 * unsigned int CallHandle;
 * unsigned int pcallList[5];
 *  tapi_response_cb callback;
 * int noOfCalls;
 * void *user_data;
 *
 * ret_status= tel_get_call_conf_list(handle, CallHandle, pcallList, &noOfCalls); // get conference call list
 * @endcode
 *
 * @see tel_join_call
 *
 ...
 * ret_status =tel_get_call_privacy_mode (handle, privacyType, callback, user_data); // get call privacy_mode
 * @endcode
 *
 *
 * @see None.
 ...
 *
 * ret_status = tel_set_call_privacy_mode (handle, pPrivacyMode_info, callback, user_data); // set call privacy mode
 * @endcode
 *
 * @see None.
 *
 ...
 * ret_status = tel_exe_call_flash_info(handle, pDialNumber, callback, user_data); // call flash info
 * @endcode
 *
 * @see None.
 *
 ...
 * TapiHandle *handle;
 * void *user_data;
 * ret = tel_exit_call_emergency_mode (handle, callback, user_data); // emergency call
 *
 * @endcode
 *
 * @see None.
