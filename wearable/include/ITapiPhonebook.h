 ...
 *
 * @par Async Response Message:
 * The event data is #TelSimPbStorageInfo_t.
 ...
 * int request_id = 0;
 * TapiHandle *handle; // handle given by tel_init()
 * tapi_response_cb callback; // Initialized callback function pointer in which response is returned
 * TelSimPbType_t storage_type = 0x00;
 * storage_type = TAPI_SIM_PB_3GSIM; // usim phonebook
 * err_code = tel_get_sim_pb_count(handle, storage_type, callback, &request_id);
 * @endcode
 *
 * @remarks None
 *
 ...
 *
 * @par Async Response Message:
 * The event data is #TelSimPbEntryInfo_t.
 * Asynchronous return status is indicated by #TelSimPbAccessResult_t.
 *
 * @pre
 *  - A dbus connection is established with #tel_init
 ...
 * tapi_response_cb callback; // Initialized callback function pointer in which response is returned
 * TelSimPbType_t storage_type = 0x00;
 * storage_type = TAPI_SIM_PB_ADN; // ADN phonebook
 * err_code = tel_get_sim_pb_meta_info(handle, storage_type, callback, &request_id);
 * @endcode
 *
 * @remarks None
 *
 ...
 *
 * @par Async Response Message:
 * The event data is #TelSimPbCapabilityInfo_t.
 * Asynchronous return status is indicated by #TelSimPbAccessResult_t.
 *
 * @pre
 *  - A dbus connection is established with #tel_init
 ...
 * TapiHandle *handle; // handle given by tel_init()
 * tapi_response_cb callback; // Initialized callback function pointer in which response is returned
 * err_code = tel_get_sim_pb_usim_meta_info(handle, callback, &request_id);
 * @endcode
 *
 * @remarks None
 *
...
/**
 * @brief  This API is used to read SIM phone book entry information from given storage type and index.
 *	Access to this API is limited to in-house application and we recommend you use phonebook-engine APIs.
 *
 * This function makes Dbus method call to Telephony Sever and returns immediate value.
 * However it just means that the API request has been transfered to the CP successfully.
 ...
 *
 * @par Async Response Message:
 * The event data is #TelSimPbRecord_t.
 * Asynchronous return status is indicated by #TelSimPbAccessResult_t.
 *
 * @pre
 *  - A dbus connection is established with #tel_init
 ...
 * TelSimPbType_t storage_type = 0x00;
 * storage_type = TAPI_SIM_PB_3GSIM; // usim phonebook
 * err_code = tel_read_sim_pb_record(handle, storage_type, index, callback, &request_id);
 * @endcode
 *
 * @remarks None
 *
 ...
 * err_code = tel_update_sim_pb_record(handle, &data, callback, &request_id);
 * @endcode
 *
 * @remarks None
 *
 ...
 * TelSimPbType_t storage_type = 0x00;
 * storage_type = TAPI_SIM_PB_3GSIM; // usim phonebook
 * err_code = tel_delete_sim_pb_record(handle, storage_type, index, callback, &request_id);
 * @endcode
 *
 * @remarks None
 *
