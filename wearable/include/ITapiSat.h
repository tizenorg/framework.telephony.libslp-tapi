 ...
 * ret_status = tel_select_sat_menu(handle, &selected_menu, callback, user_data);
 * @endcode
 *
 * @remarks None
 *
 ...
 * ret_status = tel_download_sat_event(handle, &pEventData, callback, user_data);
 * @endcode
 *
 * @remarks None
 *
 ...
 * TapiHandle *handle;  // Handle given by tel_init()
 * ret_status = 0;
 * ret_status = tel_send_sat_ui_display_status(handle, commandId, TAPI_SAT_DISPLAY_SUCCESS);
 * @endcode
 *
 * @remarks None
 *
 ...
 * ret_status = tel_send_sat_ui_user_confirm(handle, &cfm_data);
 * @endcode
 *
 * @remarks None
 *
 ...
 *
 * Once the USIM supplies the SET UP MENU proactive command, telephony server not only publish
 ...
 * ret_status = tel_get_sat_main_menu_info(handle, &menu);
 * @endcode
 *
 * @remarks None
 *
 ...
 * ret_status = tel_send_sat_app_exec_result(handle, &app_ret);
 * @endcode
 *
 * @remarks None
 *
