 ...
 * Asynchronous return status is indicated by #TelSsBarringResp_t.
 *
 * @pre
 ...
 * ret_status = tel_set_ss_barring (handle,&pBarringInfo,callback,user_data);
 * @endcode
 *
 * @remarks
 * - None
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret_status = tel_get_ss_barring_status(handle,CallType,BarType,callback,user_data); // get barring status
 ...
 *
 * @par Async Response Message:
 * Asynchronous return status will be succes or failure.
 *
 * @pre
 *  - Initialize Dbus connection with #tel_init
 *  - Register caller's application name with #tel_register_app_name
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret_status = tel_change_ss_barring_password (handle,"0000","1111","1111",callback,user_data); // change barring password
 *
 * @endcode
 *
 * @remarks
 ...
 *
 * @par Async Response Message:
 *  Asynchronous return status is indicated by #TelSsForwardResp_t.
 *
 * @pre
 *  - Initialize Dbus connection with #tel_init
 *  - Register caller's application name with #tel_register_app_name
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret_status = tel_get_ss_forward_status(handle,type,condition,callback,user_data); // get forward status
 *
 * @endcode
 * @remarks
 * - None
 ...
 *
 * @par Async Response Message:
 *  Asynchronous return status is indicated by #TelSsWaitingResp_t.
 *
 * @pre
 *  - Initialize Dbus connection with #tel_init
 *  - Register caller's application name with #tel_register_app_name
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret_status = tel_set_ss_waiting (handle,&waitInfo,callback,user_data); // set call waiting
 * @endcode
 *
 * @remarks
 * - None
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret_status = tel_get_ss_waiting_status (handle,CallType,callback,user_data); // get call waiting info
 * @endcode
 *
 * @remarks
 * - None
...
/**
 *
 * @brief  This function activates/deactivates the status of calling line identity service.
 *
 * @par Notes:
 ...
 *
 * @par Async Response Message:
 *  Asynchronous return status is indicated by #TelSsCliResp_t.
 *
 * @pre
 *  - Initialize Dbus connection with #tel_init
 *  - Register caller's application name with #tel_register_app_name
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret_status = tel_set_ss_cli_status(handle,CliType,CliStatus,callback,user_data); // get cli info
 * @endcode
 *
 * @see
 * - None
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret_status = tel_get_ss_cli_status(handle,CliType,callback,user_data); // get cli info
 * @endcode
 *
 * @see
 * - None
 ...
 *
 * @par Async Response Message:
 *  Asynchronous return status is indicated by #TelSsUssdResp_t.
 *
 * @pre
 *  - Initialize Dbus connection with #tel_init
 *  - Register caller's application name with #tel_register_app_name
 ...
 *
 * ret = tel_send_ss_ussd_request(handle,ussdString,callback,user_data); // request ussd
 * @endcode
 *
 * @remarks
 * - None
 ...
 * void *user_data;
 *
 * ret_status = tel_get_ss_aoc_info (handle,AocType,callback,user_data); // get AOC info
 * @endcode
 *
 * @remarks
 * - None
 ...
 * tapi_response_cb callback; //Initialized call-back function pointer in which response is returned
 *
 * ret = tel_set_ss_aoc_info (handle,pAocSetInfo,callback,user_data); // set aoc info
 * @endcode
 *
 *
 * @remarks
