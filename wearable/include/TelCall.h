...
#define	TAPI_CALL_DIAL_NUMBER_LEN_MAX	82		/**< Maximum Dail Number Length */
...
typedef enum {
	...
	TAPI_CAUSE_REJ_SAT_CALL_CTRL,		/**< Rejection SAT Call Contorl */
 ...
 */
typedef enum {
	TAPI_CALL_MT_CLI_PRESENT = 0x31, /**< Number details are present in the "char number" of call info struct. if number is not present then "no cli cause" member in  mt_ss_info is set accordingly.*/
	TAPI_CALL_MT_CNA_PRESENT = 0x32, /**< Calling Name Info presnet,TelCallingNameInfo_t of call info struct contains this info.*/
...
typedef enum {
	...
	TAPI_CALL_ECC_NONE = 0xff, /**< unspecfied emergency */
...
typedef void (*TelCallStatusCallback)( TelCallStatus_t *out, void *user_data ); /**< Callback function to get call status*/
...
/**
 * Call Sound recording ON/OFF.
 */
typedef enum {
	TAPI_SOUND_RECORDING_OFF, /**< Call Sound Recording OFF */
	TAPI_SOUND_RECORDING_ON, /**< Call Sound Recording ON */
...
typedef enum {
	...
	TAPI_SOUND_DEVICE_HFK = 0x20, /**< Device type Hand free */
...
typedef enum {
	...
	TAPI_SOUND_PATH_MIC1		    =0x09, /**<Audio path Mice one*/
	TAPI_SOUND_PATH_MIC2		    =0x0A, /**<Audio path Bluetooth mice two*/
...
typedef enum {
	TAPI_SOUND_EQUALIZATION_MODE_OFF, /**< Sound equalization mode is off */
	TAPI_SOUND_EQUALIZATION_MODE_ON, /**< Sound equalization mode is on*/
	TAPI_SOUND_EQUALIZATION_MODE_FLAG_OFF, /**< Sound  equalization mode flag is off*/
	TAPI_SOUND_EQUALIZATION_MODE_FLAG_ON, /**< Sound  equalization mode flag is on */
	TAPI_SOUND_EQUALIZATION_MODE_SOFT1, /**< Sound  equalization mode soft 1*/
	TAPI_SOUND_EQUALIZATION_MODE_SOFT2, /**< Sound  equalization mode soft 2*/
} TelSoundEqualizationMode_t;

typedef enum {
	TAPI_SOUND_DIRECTION_LEFT, /**< Sound direction left*/
	TAPI_SOUND_DIRECTION_RIGHT, /**< Sound  direction right*/
} TelSoundDirection_t;
...
typedef enum {
	...
	TAPI_CALL_SOUND_WBAMR_STATUS_OFF_16K,
	TAPI_CALL_SOUND_WBAMR_STATUS_ON_8K,
