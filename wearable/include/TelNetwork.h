...
typedef enum {
	...
	TAPI_NETWORK_SERVICE_TYPE_SEARCH,			/**< Service type is Serching */
	TAPI_NETWORK_SERVICE_TYPE_2G,				/**< Service type is 2G */
	TAPI_NETWORK_SERVICE_TYPE_2_5G,				/**< Service type is 2.5G */
	TAPI_NETWORK_SERVICE_TYPE_2_5G_EDGE,		/**< Service type is 2.5G (EDGE) */
	TAPI_NETWORK_SERVICE_TYPE_3G,				/**< Service type is 3G */
...
typedef enum
{
	...
	TAPI_NETWORK_OPERATION_ABORTED,				/**< This error is sent when operation is aborted */
...
struct tel_noti_network_registration_status {
	int cs; /**< Circuit Switched status */
	int ps; /**< Packet Swithced status  */
	int type; /**< Registration service type  */
	int is_roaming; /**< Roaming status  */
};
