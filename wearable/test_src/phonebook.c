...
static int run_pb_read_sim_pb_record(MManager *mm, struct menu_data *menu)
{
	...
	pb_type = data_pb_type[0] - '0';
	index = data_pb_index[0] -'0';
	msg("request pb [%d], index[%d]", pb_type, index);
